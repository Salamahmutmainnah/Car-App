<aside
    ...
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-purple-500 ease-linear lg:static lg:translate-x-0"
...
>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
            <!-- Menu Group -->
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark5 ">MENU</h3>
            ...
            <!-- Others Group -->
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark5">
                    Master Data
                </h3>
