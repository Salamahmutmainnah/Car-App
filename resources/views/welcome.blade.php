...
<style>
    ...
    .gallery {
        display: flex;
        flex-wrap: wrap;
        justify-content: center; /* Mengatur agar foto-foto berada di tengah */
        max-width: 800px;
        margin: 0 auto;
    }
...
<div class="gallery">
    <div class="photo">
        <img src="src/images/car/salamah.jpg" alt="Orang Pertama">
        <p>Salamah Mutmainnah - 0110123272</p>
    </div>
    <div class="photo">
        <img src="src/images/car/niha.jpg" alt="Orang Kedua">
        <p>Nihayatul janiah - 0110123071</p>
    </div>
    <div class="photo">
        <img src="src/images/car/salsa.jpg" alt="Orang Ketiga">
        <p>nursalsabilah - 0110123259</p>
    </div>
    <div class="photo">
        <img src="src/images/car/erna.jpg" alt="Orang Keempat">
        <p>Erna Wati - 0110123029</p>
    </div>
    <div class="photo">
        <img src="src/images/car/novela.jpg" alt="Orang Kelima">
        <p>Novela - 0110123228</p>
    </div>
</div>
